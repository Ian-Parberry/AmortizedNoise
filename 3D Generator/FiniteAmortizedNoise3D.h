/// \file FiniteAmortizedNoise3D.h
/// \brief Header file for the 3D amortized noise class CFiniteAmortizedNoise3D.
///
...
class CFiniteAmortizedNoise3D{
  ...
  private: //Amortized noise stuff
    ...
    unsigned int h(const unsigned int x, const unsigned int y, const unsigned int z); ///< 3D hash function.
  ...
  public:
    CFiniteAmortizedNoise3D(const int n); ///< Constructor.
    ~CFiniteAmortizedNoise3D(); ///< Destructor.
